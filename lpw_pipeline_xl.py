# Copied from https://github.com/huggingface/diffusers/blame/main/examples/community/lpw_stable_diffusion_xl.py
## ----------------------------------------------------------
...
def get_weighted_text_embeddings_sdxl(
    ...
    for i in range(len(prompt_token_groups)):
        ...
        print("1:", len(token_tensor), "2:", len(token_tensor_2))
